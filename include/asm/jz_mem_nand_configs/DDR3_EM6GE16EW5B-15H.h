...
#define DDR_tCWL    6	/* DDR3 only: CAS Write Latency, 5 to 8 */
#endif
...
#define DDR_tWR  15  /*FIXME WRITE Recovery Time defined by register MR of DDR3 memory, ns*/
...
#define DDR_tRFC   315 	/* AUTO-REFRESH command period. DDR3 - ns*/
#define DDR_tMINSR 60   /*FIXME Minimum Self-Refresh / Deep-Power-Down . DDR3 no*/
#define DDR_tXP    MAX(3, 6)	/*FIXME DDR3 only: Exit active power down to any valid command, ns*/
