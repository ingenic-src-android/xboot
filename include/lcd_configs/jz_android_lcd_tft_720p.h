...
#ifndef __ANDROID_LCD_TFT_720P_H__
#define __ANDROID_LCD_TFT_720P_H__

void ANDROID_LCD_TFT_720P_panel_display_on(void);
void ANDROID_LCD_TFT_720P_panel_display_off(void);
void ANDROID_LCD_TFT_720P_panel_display_pin_init(void);
