...
#define BURN_VERSION "burn version: npm801-V-3.0.1\n"
#define XBOOTVERSION "\nx-boot version: npm801-V-3.0.1\n\n"
...
#undef CONFIG_ENABLE_DDR_ODT
#undef CONFIG_ENABLE_PHY_ODT
#define CONFIG_DDR3PHY_PULLUP_IMPEDANCE		0xe
#define CONFIG_DDR3PHY_PULLDOWN_IMPEDANCE	0xe
...
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000 androidboot.serialno=TAB4780801"
...
#define CONFIG_NO_MASS_STORAGE 0
/*-----------------------------------------------------------------------
 * Nand Partition info
 */
#if CONFIG_NO_MASS_STORAGE
...
#define PTN_USERDATA_SIZE          ( (3376 - 512) * 0x100000UL)
#else
#define PTN_BOOT_OFFSET            (   8 * 0x100000)
#define PTN_BOOT_SIZE              (  16 * 0x100000)
#define PTN_RECOVERY_OFFSET        (  24 * 0x100000)
