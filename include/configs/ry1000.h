...
/* DDR chip */
#ifdef COFIG_SDRAM_LPDDR2
#include "asm/jz_mem_nand_configs/LPDDR2_H9TP32A4GDBCPR.h"
#else
...
//#include "asm/jz_mem_nand_configs/DDR3_H5TQ4G83AFR-PBC.h"
#endif
...
#define CFG_CPU_SPEED		(1248 * 1000000)           //mpll
...
//#define VPLL_CLOCK_1188 (1188*1000000)
#define VPLL_CLOCK    (888*1000000)            // VPLL for HDMI
...
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=256M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=32M@0x5e000000"
...
#define CFG_NAND_SMCR1          	( (0xf << 24) | (0xc << 20)| (0xc << 16) | (0x8 << 12) | (0x8 << 8))	/* 0x0fff7700 is slowest */
...
#define GPIO_VBUS_PIN			(32*4 + 10)/*GPE20*/
#define GPIO_VBUS_PIN_LEVEL		(1)
...
#define XBOOT_SEL_FAST_KEY             (GPIO_BOOT_SEL0)

#define XBOOT_SEL_RCVR_KEY             (-1)
/*======================================================================
 * Battery  QYANG
 */
