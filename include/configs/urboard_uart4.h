...
#define CFG_UART_BASE  		UART4_BASE		/* Base of the UART channel */
...
#else
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS4,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000"
#endif
