...
/* DDR chip */
#include "asm/jz_mem_nand_configs/DDR3_EM6GE16EW5B-15H.h"

/* NAND FLASH chip*/
#include "asm/jz_mem_nand_configs/NAND_H27UBG8T2ATR.h"
...
#define XBOOT_SEL_RCVR_KEY            GPIO_KEY_MENU// GPIO_KEY_VOLUME_INC
/*======================================================================
 * Battery  QYANG
 */
...
#define LCD_RESET_PIN   	GPIO_NULL      	/*PE11----grus*/
#define LCD_VCC_EN      	GPIO_NULL        	/*PE9----grus*/
#define LCD_DE_PIN      	(32*2 + 9)       	/*PC09*/
#define LCD_VSYNC_PIN   	GPIO_NULL			/*PC19*/
#define LCD_HSYNC_PIN   	GPIO_NULL			/*PC18*/
