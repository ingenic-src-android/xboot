...
#define LOW_BATTERY_MIN	3450 //6.9V
...
//#define CFG_CPU_SPEED		(928 * 1000000)           //mpll
//#define CFG_CPU_SPEED		(1200 * 1000000)           //mpll
//#define CFG_CPU_SPEED		(1008 * 1000000)           //mpll
...
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init  pmem_camera=16M@0x5f000000 ubi.mtd=2 ubi.mtd=3 ubi.mtd4"

//#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000 ubi.mtd=2 ubi.mtd=3 ubi.mtd=4 rootfstype=ubifs"
...
#define GPIO_CHARGE_DETECT		(32*5 + 5)	/*GPF5 */
...
#define GPIO_CHARG_STAT_N	GPIO_CHARGE_DETECT
...
#define DEFAULT_BACKLIGHT_LEVEL 50 
#define LCD_PWM_PERIOD		1000000	/* pwm period in ns */
...
#define GPIO_LCD_PWM_EN   		(32*5 + 10) 	 /* backlight enable */
#define GPIO_LCD_DISP_N 		(32*5 + 11)        /*LCD_DISP_N */
