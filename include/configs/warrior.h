...
#else
#define CONFIG_BOOTARGS		"mem=256M@0x0 mem=752M@0x30000000 console=ttyS3,57600n8 ip=off root=/dev/ram0 rw rdinit=/init pmem_camera=16M@0x5f000000 androidboot.serialno=TAB4780706AB"
#endif
...
#define CONFIG_NO_MASS_STORAGE 1
/*-----------------------------------------------------------------------
 * Nand Partition info
 */
...
#define PTN_SYSTEM_SIZE            ( (512 + 138) * 0x100000)
#define PTN_CACHE_OFFSET           ( (576 + 138) * 0x100000)
#define PTN_CACHE_SIZE             ( 128 * 0x100000)
#define PTN_USERDATA_OFFSET        ( (704 + 138) * 0x100000)
#define PTN_USERDATA_SIZE          ( (3376 - 138) * 0x100000UL)
#else
#define PTN_BOOT_OFFSET            (   8 * 0x100000)
#define PTN_BOOT_SIZE              (  16 * 0x100000)
#define PTN_RECOVERY_OFFSET        (  24 * 0x100000)
...
#define XBOOT_SEL_RCVR_KEY              (32 * 1 + 5)
/*======================================================================
 * Battery  QYANG
 */
