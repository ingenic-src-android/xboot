...
#elif defined(CONFIG_LCD_HS_DS07012D)
        #include <lcd_configs/hs_ds07012d.h>
#elif defined(CONFIG_LCD_KD301_M03545_0317A)
	#include <lcd_configs/KD301_M03545_0317A.h>
#elif defined(CONFIG_LCD_TM035PDH03)
...
#define __lcd_set_backlight_level(n)					\
	do {								\
		...
		if (_val<1)						\
			_val =1;					\
		if (LCD_PWM_PERIOD < 200)		\
			_period = 200;				\
		else if (LCD_PWM_PERIOD > 1000000000)	\
			_period = 1000000000;				\
		else									\
			_period = LCD_PWM_PERIOD;			\
		_period = JZ_EXTAL * _period / 1000000000;	\
		...
		switch(prescaler) {								\
			case 2:										\
				...
				break;									\
			case 3:										\
				__tcu_select_clk_div16(LCD_PWM_CHN);	\
				break;									\
			case 4:										\
				__tcu_select_clk_div64(LCD_PWM_CHN);	\
				break;									\
			case 5:										\
				__tcu_select_clk_div256(LCD_PWM_CHN);	\
				break;									\
			case 6:										\
				__tcu_select_clk_div1024(LCD_PWM_CHN);	\
				break;									\
			case 1:										\
			default:									\
		...
		__tcu_set_full_data(LCD_PWM_CHN, _period);		\
		__tcu_set_half_data(LCD_PWM_CHN, _period * _val / (LCD_PWM_FULL)); \
