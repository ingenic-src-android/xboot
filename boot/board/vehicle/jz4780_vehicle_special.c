...
/*
 *  jz4780_vehicle_special -- define special functions of jz4780 test board.
 *
 */
...
{
	serial_puts_info("vehicle board_lcd_board_init\n");
	set_lcd_power_on();
	__gpio_as_lcd_24bit();
}
...
int board_private_init(void)
{
	...
	serial_puts_info("vehicle low i2c pin\n");
...
#if 1
#if 0
	//if the board is old vehicle:aa, you can open the if condition
